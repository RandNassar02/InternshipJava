...
class RunnableDemo6 implements Runnable {
    RunnableDemo6() {
...
public class JoiningThreadsExample3 {
    public static void main(String[] args) throws InterruptedException {
        Thread t1 = new Thread( new RunnableDemo6(), "Thread-1");
        Thread t2 = new Thread( new RunnableDemo6(), "Thread-2");
        Thread t3 = new Thread( new RunnableDemo6(), "Thread-3");
